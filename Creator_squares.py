...
class Creator_squares():
    ...
    def create_squares_single_img(self, path_img):
        print("-"*20)
        ...
        try:
            ...
            for img_single in square_imgs:
                ...
                counter2 += 1
            print(" img_" + img_name_short + ": done")

        except:
            print(" img_" + img_name_short + ": could not be split into squares")
